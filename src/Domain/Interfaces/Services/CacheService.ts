export interface CacheService {
    ...
    addToSet(key: string, member: string | number, ...members: (string | number)[]): Promise<number>;
    removeFromSet(key: string, member: string | number, ...members: (string | number)[]): Promise<number>;
    ...
    setHash(key: string, field: string, value: string | number): Promise<0 | 1>;
  }
